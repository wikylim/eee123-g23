...
int raw2[][2] = {{0, 0}};
int raw3[][2] = {{0, 0}, {100, 100}, {499, 100}, {299, 100}};
...
for(int i=0;i<data1_Index;i++){
    if(i==data1_Index-1){}              // skip last index
    else{
        for(int i=0;i<data1_Index;i++){
            if(i==data1_Index-1){}      // skip last index
            else if(data1[i+1][0]<data1[i][0]){
                int tempdata[2];
...
for(int i=0;i<data2_Index;i++){
    if(i==data2_Index-1){}              // skip last index
    else{
        for(int i=0;i<data2_Index;i++){
            if(i==data2_Index-1){}      // skip last index
            else if(data2[i+1][0]<data2[i][0]){
                int tempdata[2];
...
for(int i=0;i<data3_Index;i++){
    if(i==data3_Index-1){}              // skip last index
    else{
        for(int i=0;i<data3_Index;i++){
            if(i==data3_Index-1){}      // skip last index
            else if(data3[i+1][0]<data3[i][0]){
                int tempdata[2];
