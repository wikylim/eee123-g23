...
int data1_Index = sizeof(raw1) / sizeof(raw1[0]);//getIndex(raw1);
int data2_Index = sizeof(raw2) / sizeof(raw2[0]);//getIndex(raw2);
int data3_Index = sizeof(raw3) / sizeof(raw3[0]);//getIndex(raw3);
