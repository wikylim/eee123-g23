...
int x2Jump[5] = {0, 0, 0, 0, 0}; 
int x3Jump[5] = {0, 0, 0, 0, 0}; 
...
cout << "\ndata2 y-coord: ";
cout << "\nx100B: ";
for(int i=0;i<xcoord2[0];i++){              // get xcoord y-coordinate for raw1
...
cout << "\ndata3 y-coord: ";
cout << "\nx100C: ";
for(int i=0;i<xcoord3[0];i++){              // get xcoord y-coordinate for raw1
...
displayMatrix(dataB, "R a w   1", 1);
displayMatrix(dataC, "R a w   1", 1);
...
displayMatrix(data, "F i n a l", 0);
